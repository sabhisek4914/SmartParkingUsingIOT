...
<body>
    <div class="container">
        ...
        <div class="row"><!-- PS1 -->
            ...
            <p id="payload1">PARKING STATION 1</p>
        ...
        <div class="row"><!-- PS2 -->
            <p id="payload1">PARKING STATION 2</p>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
        ...
        <div class="row"><!-- PS3 -->
            <p id="payload1">PARKING STATION 3</p>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
        ...
        <div class="row"><!-- PS4 -->
            <p id="payload1">PARKING STATION 4</p>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
...
function callP3incr()
{
	...
	z++;		
	swindow.location.replace("parking1.jsp?param3="+z);		
}
function callP4incr()
{
